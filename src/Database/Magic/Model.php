...
abstract class Model implements ArrayAccess, JsonSerializable
{
     ...
     *
     * @var \Globalis\PuppetSkilled\Events\Dispatcher
     */
    ...
    public static function flushEventListeners()
    {
        ...
        foreach ($instance->getObservableEvents() as $event) {
            static::$dispatcher->forget("puppet.{$event}: ".static::class);
        }
    }
     ...
     *
     * @return \Globalis\PuppetSkilledDatabase\Query\Builder
     */
    ...
    public function getTable()
    {
        ...
        return str_replace('\\', '', str_snake(class_basename($this)));
    }
    ...
    public function isFillable($key)
    {
        ...
        return empty($this->getFillable()) && !(substr($key, 0, 1) === '_');
    }
     ...
     *
     * @param  \CI_DB_Driver  $resolver
     * @return void
     */
    public static function setConnectionResolver(\CI_DB_Driver $resolver)
    {
     ...
     *
     * @param  \Globalis\PuppetSkilled\Events\Dispatcher  $dispatcher
     * @return void
     */
