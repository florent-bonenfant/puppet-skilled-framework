<?php
namespace Globalis\PuppetSkilled\Database\Query;
...
class Builder
{
     ...
     *
     * @var \Globalis\PuppetSkilled\Database\Query\Grammar
     */
    protected $grammar;
     ...
     * @param  \Globalis\PuppetSkilled\Database\Query\Grammar  $grammar
     * @return void
     */
    public function __construct(CI_DB_driver $connection, Grammar $grammar = null)
    {
     ...
     *
     * @param  \Closure|\Globalis\PuppetSkilled\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \Globalis\PuppetSkilled\Database\Query\Builder|static
     *
     ...
     *
     * @param  \Globalis\PuppetSkilled\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
    ...
    protected function addDynamic($segment, $connector, $parameters, $index)
    {
        ...
        $segment = mb_strtolower(preg_replace('/(.)(?=[A-Z])/u', '$1'.'_', $segment));
     ...
     *
     * @param  \Globalis\PuppetSkilled\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \Globalis\PuppetSkilled\Database\Query\Builder|static
     */
    ...
    {
        return $this->connection->query($this->toSql(), $this->getBindings())->result();
    }
    ...
    public function pluck($column, $key = null)
    {
        ...
        return array_pluck($results, $this->stripTableForPluck($column), $this->stripTableForPluck($key));
    }
    ...
    public function exists()
    {
        ...
        $results = $this->connection->query($sql, $this->getBindings())->result();
    ...
    public function update(array $values)
    {
        ...
        return $this->connection->query($sql, $this->cleanBindings(
     ...
     *
     * @param  mixed  $value
     * @return \Globalis\PuppetSkilled\Database\Query\Expression
     */
     ...
     *
     * @return \Globalis\PuppetSkilled\Database\Query\Grammar
     */
