    ...
    <div class="card-block">
        ...
        <form action="<?= site_url($baseUrl) ?>" method="get" accept-charset="utf-8" class="FilterForm">
            <div class="form-group">
                <label for="<?= $preprendId ?>content" class="form-label"><?= lang($part . '_label_filter_search'); ?></label>
...
<?= $this->element(
    ...
    [
        ...
        'displayed_fields' => [
            [
                'query_key' => 'title_key',
                'label' => 'lang:' . $part . '_label_libelle',
            ],
            [
                'query_key' => 'title',
                'label' => 'lang:' . $part . '_label_subject',
            ],
            [
                'label' => '',
                'class' => 'table-actions',
