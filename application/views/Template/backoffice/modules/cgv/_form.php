...
?>
    <div class="wrap-contributor">
        <p><?= sprintf(lang('cgv_contributor_add'), '<b>' . $item->creator->first_name . '</b>', '<b>' . $item->creator->last_name . '</b>', '<b>' . user_date_format($item->created_at, false) . '</b>') ?></p>
        <p><?= sprintf(lang('cgv_contributor_edit'), '<b>' . $item->updator->first_name . '</b>', '<b>' . $item->updator->last_name . '</b>', '<b>' . user_date_format($item->updated_at, false) . '</b>') ?></p>
    </div>
<?php
endif;
?>
...
<fieldset class="card mb-4">
    <h2 class="card-header bg-inverse text-white"><?= lang('cgv_label_content') ?></h2>
    <div class="card-block">
        ...
        ?>
            <div class="<?= $class_wrapper ?>">
                <label class="form-control-label" for="<?= $preprendId ?>document"><?= lang('cgv_label_document'); ?> *</label> 
                <?php
                $info_input = [
                    'name'  => 'document',
                    'class' => 'form-control',
            ...
            <?php
                if ($item && $item->document) : ?>
                    <a href="<?= site_url('backoffice/modules/cgv/download/' . $item->getRouteKey()) ?>" target="_blank" class="btn btn-primary">
...
<fieldset class="card mb-4">
    <h2 class="card-header bg-inverse text-white"><?= lang('cgv_label_public') ?></h2>
    <div class="card-block">
        <?php
            $error = '';
            $class_wrapper = 'form-group';
        ...
        <div class="<?= $class_wrapper ?>">
            ...
            <?= $this->element(
                'form/label',
                [
                    'label' => 'lang:cgv_label_companies',
                    'field' => 'companies[]',
...
<fieldset class="card mb-4">
    <h2 class="card-header bg-inverse text-white"><?= lang('cgv_label_publication') ?></h2>
    <div class="card-block">
        ...
        ?>
        <div class=" <?= $class_wrapper ?>">
            <label class="form-control-label" for="<?= $preprendId ?>publication_date"><?= lang('cgv_label_publication_date'); ?> *</label> 
        ...
        ?>
        <div class=" <?= $class_wrapper ?>">
            <label class="form-control-label" for="<?= $preprendId ?>end_publication_date"><?= lang('cgv_label_end_publication_date'); ?></label>
        ...
        <div class="form-group">
            <?= $this->element(
                'form/label',
                [
                    'label' => 'lang:cgv_label_send_notification',
