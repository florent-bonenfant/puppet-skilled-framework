...
?>
    <?= anchor(
        'backoffice/modules/cgv/edit/' . $item->getRouteKey(),
    ...
    <?php if (route_is_accessible('backoffice/modules/cgv/delete/' . $item->getRouteKey())) : ?>
    <?= csrf_anchor(
        'backoffice/modules/cgv/delete/' . $item->getRouteKey(),
...
<?php else :?>
    <?= csrf_anchor(
        'backoffice/modules/cgv/restore/' . $item->getRouteKey(),
