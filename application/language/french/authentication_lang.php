...
$lang['authentication_password_rules'] = 'Le mot de passe doit contenir au minimum 8 caractères, une majuscule, une minuscule et un chiffre.';
$lang['authentication_error_password_bad_format'] = 'Votre mot de passe doit contenir au minimum 8 caractères, et contenir au moins une majuscule, une minuscule et un chiffre.';
...
$lang['authentication_email_content_reset_password'] = "Vous avez reçu cet email car une demande de réinitialisation de mot de passe a été émise pour votre compte.\n
Cliquez sur le lien ci-dessous et vous serez redirigé vers une page afin de définir un nouveau mot de passe [Réinitialisation de mot de passe]({{front_url}})\n
Si vous n'avez pas effectué de demande de réinitialisation de mot de passe, aucune action n'est requise.";

$lang['authentication_title_blocked_password'] = 'Réinitialisation de votre mot de passe';
$lang['authentication_blocked_password_text'] = 'Vous avez dépassé le nombre de tentatives de connexion. Veuillez réinitialiser votre mot de passe.';
