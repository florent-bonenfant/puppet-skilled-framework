...
class FormValidation
{
    ...
    protected function applyRule(string $field, array &$metadata, string $rule, ?string $param): bool
    {
        ...
        switch ($rule) {
            ...
            case 'max_length':
                ...
                if (!$ok) {
                    $this->registerError($field, $metadata, 'max_length');
                }
                return $ok;
            ...
            case 'min_length':
                $ok = mb_strlen((string) $value) >= (int) $param;
                if (!$ok) {
                    $this->registerError($field, $metadata, 'min_length');
                }
                return $ok;
            ...
            case 'greater_than':
                ...
                if (!$ok) {
                    $this->registerError($field, $metadata, 'greater_than');
                }
                return $ok;
    ...
    protected function registerError(string $field, array &$metadata, string $message): void
    {
